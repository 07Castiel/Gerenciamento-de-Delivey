...
checkoutBtn.addEventListener("click", function() {
    ...
    const phone = "8893434821";  // Número de telefone
...
if(isOpen) {
    ...
    spanOpen.innerHTML = '<span class="font-medium text-white">Qua à Seg - 17h às 23h</span>';
...
function checkOpen() {
    ...
    // Fechado às Terças-feiras (day === 2) e aberto das 17h às 23h nos demais dias
